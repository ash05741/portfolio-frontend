...
import { motion } from "framer-motion"; // matches the import used across About/Skills/Projects
...
const socialLinks = [
  ...
  },
  {
    ...
    icon: FaGithub,
    hoverClass: "group-hover:text-slate-800 dark:group-hover:text-white",
  },
  {
    name: "Website",
    href: "https://your-domain-here.com", // TODO: replace with your live portfolio URL once deployed
    icon: Globe,
    ...
    <div>
      <section className="sticky top-0 h-screen bg-[#f5f5f7] dark:bg-slate-950 flex items-center relative z-0">
        ...
        <div className="max-w-7xl mx-auto px-6 w-full grid md:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative hidden md:flex justify-center md:mr-24 lg:mr-32" aria-hidden="true">
            <div className="text-[300px] font-bold select-none
                  ...
                  tracking-tighter lg:text-[400px] leading-none">
              ∆S
            </div>
          </div>
        </div>
            ...
            {socialLinks.map((link) => {
              ...
              return (
                ...
                >
                  ...
                  <Icon
                    size={link.name === "Website" ? 25 : undefined}
                    className={`relative transition-colors duration-300 ${link.hoverClass}`}
                  />
                </a>
              );
            })}
